                        ...
                        <div class="col">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <!--=================================================
                                    Palabras claves de la subcategoría
                                    =================================================-->
                                    ...
                                    <div class="form-group pb-3 text-center">
                                        ...
                                        <label for="image_subcategory">
                                            ...
                                            <?php if (!empty($subcategory)): ?>
                                                ...
                                                <img src="/views/assets/img/subcategories/<?php echo $subcategory->url_subcategory ?>/<?php echo $subcategory->image_subcategory ?>" alt="image default" class="img-fluid chageImage">

                                            <?php else: ?>

                                                <img src="/views/assets/img/subcategories/default/default-image.jpg" alt="image default" class="img-fluid chageImage">
                                                ...
                                                =================================================-->
                                                    ...
                                                    <figure class="mb-2">
                                                        ...
                                                        <?php if (!empty($subcategory)): ?>
                                                            ...
                                                            <img src="/views/assets/img/subcategories/<?php echo $subcategory->url_subcategory ?>/<?php echo $subcategory->image_subcategory ?>" class="img-fluid metaImg" alt="img" style="width:100%">

                                                        <?php else: ?>

                                                            <img src="/views/assets/img/subcategories/default/default-image.jpg" class="img-fluid metaImg" alt="img" style="width:100%">
