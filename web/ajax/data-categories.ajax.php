            ...
            $dataJson = '{
				...
				foreach ($data as $key => $value) {
            		...
            		if($value->status_category == 1){
	            		...
	            		$status_category = "<input type='checkbox' data-size='mini' data-off-color='danger' data-on-color='dark' checked='true' idItem='".base64_encode($value->id_category)."' table='categories' column='category'>";
